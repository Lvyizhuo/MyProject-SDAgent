...
const sanitizeSelectionState = (sourceData, options, folders) => {
    ...
    const selectedKnowledgeBaseId = next.knowledgeBaseId ?? next.knowledgeBaseFolderId;
    if (selectedKnowledgeBaseId != null && !folders.some((folder) => folder.id === selectedKnowledgeBaseId)) {
        next.knowledgeBaseId = null;
        next.knowledgeBaseFolderId = null;
        next.knowledgeBaseFolderName = null;
        next.knowledgeBaseFolderPath = null;
        next.knowledgeBaseName = null;
        next.knowledgeBasePath = null;
        changed = true;
    }
...
const ConfigPanel = ({ config, onSave, onReset }) => {
    ...
    const handleKnowledgeBaseChange = (value) => {
        ...
        setFormData((prev) => ({
            ...prev,
            knowledgeBaseId: value ? Number(value) : null,
            knowledgeBaseFolderId: value ? Number(value) : null,
            knowledgeBaseName: value ? selectedFolder?.name || null : null,
            knowledgeBasePath: value ? selectedFolder?.path || null : null,
            ...
            <div className="config-form">
                ...
                <div className="form-section">
                    ...
                    <div className="form-group">
                        <label>知识库目录</label>
                        <select
                            value={formData.knowledgeBaseId ?? formData.knowledgeBaseFolderId ?? ''}
                        ...
                        <p className="field-note">
                            保存后立即生效。选择知识库后，智能体会自动使用该知识库绑定的向量表与嵌入模型。
                        </p>
                        <p className="field-hint compact">
                            当前范围：{formData.knowledgeBasePath || formData.knowledgeBaseFolderPath || '全部知识库'}
                        </p>
                    </div>
                </div>
